...
import (
	...
	types1 "github.com/tachibtc/cometbft/proto/tendermint/types"
...
type Request_InsertTx struct {
	InsertTx *RequestInsertTx `protobuf:"bytes,21,opt,name=insert_tx,json=insertTx,proto3,oneof" json:"insert_tx,omitempty"`
}
type Request_ReapTxs struct {
	ReapTxs *RequestReapTxs `protobuf:"bytes,22,opt,name=reap_txs,json=reapTxs,proto3,oneof" json:"reap_txs,omitempty"`
}
...
func (*Request_InsertTx) isRequest_Value()            {}
func (*Request_ReapTxs) isRequest_Value()             {}
...
func (m *Request) GetInsertTx() *RequestInsertTx {
	if x, ok := m.GetValue().(*Request_InsertTx); ok {
		return x.InsertTx
	}
	return nil
}

func (m *Request) GetReapTxs() *RequestReapTxs {
	if x, ok := m.GetValue().(*Request_ReapTxs); ok {
		return x.ReapTxs
	}
	return nil
}
...
type RequestInsertTx struct {
	Tx []byte `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"`
}

func (m *RequestInsertTx) Reset()         { *m = RequestInsertTx{} }
func (m *RequestInsertTx) String() string { return proto.CompactTextString(m) }
func (*RequestInsertTx) ProtoMessage()    {}
func (*RequestInsertTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{7}
}
func (m *RequestInsertTx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestInsertTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestInsertTx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestInsertTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestInsertTx.Merge(m, src)
}
func (m *RequestInsertTx) XXX_Size() int {
	return m.Size()
}
func (m *RequestInsertTx) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestInsertTx.DiscardUnknown(m)
}

var xxx_messageInfo_RequestInsertTx proto.InternalMessageInfo

func (m *RequestInsertTx) GetTx() []byte {
	if m != nil {
		return m.Tx
	}
	return nil
...
func (m *RequestReapTxs) Reset()         { *m = RequestReapTxs{} }
func (m *RequestReapTxs) String() string { return proto.CompactTextString(m) }
func (*RequestReapTxs) ProtoMessage()    {}
func (*RequestReapTxs) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{8}
}
func (m *RequestReapTxs) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestReapTxs) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestReapTxs.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestReapTxs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestReapTxs.Merge(m, src)
}
func (m *RequestReapTxs) XXX_Size() int {
	return m.Size()
}
func (m *RequestReapTxs) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestReapTxs.DiscardUnknown(m)
}

var xxx_messageInfo_RequestReapTxs proto.InternalMessageInfo

func (m *RequestReapTxs) GetMaxBytes() uint64 {
	if m != nil {
		return m.MaxBytes
	}
	return 0
...
func (m *RequestReapTxs) GetMaxGas() uint64 {
	if m != nil {
		return m.MaxGas
	}
	return 0
...
type Response_InsertTx struct {
	InsertTx *ResponseInsertTx `protobuf:"bytes,22,opt,name=insert_tx,json=insertTx,proto3,oneof" json:"insert_tx,omitempty"`
}
type Response_ReapTxs struct {
	ReapTxs *ResponseReapTxs `protobuf:"bytes,23,opt,name=reap_txs,json=reapTxs,proto3,oneof" json:"reap_txs,omitempty"`
}
...
func (*Response_InsertTx) isResponse_Value()            {}
func (*Response_ReapTxs) isResponse_Value()             {}
...
func (m *Response) GetInsertTx() *ResponseInsertTx {
	if x, ok := m.GetValue().(*Response_InsertTx); ok {
		return x.InsertTx
	}
	return nil
}

func (m *Response) GetReapTxs() *ResponseReapTxs {
	if x, ok := m.GetValue().(*Response_ReapTxs); ok {
		return x.ReapTxs
	}
	return nil
}
...
func (*Response) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Response_InsertTx)(nil),
		(*Response_ReapTxs)(nil),
	}
}
...
type ResponseInsertTx struct {
	Code uint32 `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
}

func (m *ResponseInsertTx) Reset()         { *m = ResponseInsertTx{} }
func (m *ResponseInsertTx) String() string { return proto.CompactTextString(m) }
func (*ResponseInsertTx) ProtoMessage()    {}
func (*ResponseInsertTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{27}
}
func (m *ResponseInsertTx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseInsertTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseInsertTx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseInsertTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseInsertTx.Merge(m, src)
}
func (m *ResponseInsertTx) XXX_Size() int {
	return m.Size()
}
func (m *ResponseInsertTx) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseInsertTx.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseInsertTx proto.InternalMessageInfo

func (m *ResponseInsertTx) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
type ResponseReapTxs struct {
	Txs [][]byte `protobuf:"bytes,1,rep,name=txs,proto3" json:"txs,omitempty"`
}

func (m *ResponseReapTxs) Reset()         { *m = ResponseReapTxs{} }
func (m *ResponseReapTxs) String() string { return proto.CompactTextString(m) }
func (*ResponseReapTxs) ProtoMessage()    {}
func (*ResponseReapTxs) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{28}
}
func (m *ResponseReapTxs) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseReapTxs) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseReapTxs.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseReapTxs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseReapTxs.Merge(m, src)
}
func (m *ResponseReapTxs) XXX_Size() int {
	return m.Size()
}
func (m *ResponseReapTxs) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseReapTxs.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseReapTxs proto.InternalMessageInfo

func (m *ResponseReapTxs) GetTxs() [][]byte {
	if m != nil {
		return m.Txs
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RequestInsertTx)(nil), "tendermint.abci.RequestInsertTx")
	proto.RegisterType((*RequestReapTxs)(nil), "tendermint.abci.RequestReapTxs")
	...
	proto.RegisterType((*ResponseInsertTx)(nil), "tendermint.abci.ResponseInsertTx")
	proto.RegisterType((*ResponseReapTxs)(nil), "tendermint.abci.ResponseReapTxs")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	0x1e, 0x42, 0x72, 0x39, 0x8b, 0xc7, 0x43, 0xa0, 0x41, 0x8c, 0x05, 0x60, 0xc6, 0x33, 0x03, 0x1a,
	...
	,
}
...
func (m *Request_InsertTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_InsertTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.InsertTx != nil {
		{
			size, err := m.InsertTx.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Request_ReapTxs) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_ReapTxs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ReapTxs != nil {
		{
			size, err := m.ReapTxs.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestInsertTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestInsertTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestInsertTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RequestReapTxs) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestReapTxs) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestReapTxs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_InsertTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_InsertTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.InsertTx != nil {
		{
			size, err := m.InsertTx.MarshalToSizedBuffer(dAtA[:i])
...
func (m *Response_ReapTxs) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_ReapTxs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ReapTxs != nil {
		{
			size, err := m.ReapTxs.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseInsertTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseInsertTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseInsertTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResponseReapTxs) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseReapTxs) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseReapTxs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Request_InsertTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request_ReapTxs) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestInsertTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestReapTxs) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_InsertTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_ReapTxs) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseInsertTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseReapTxs) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InsertTx", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Value = &Request_InsertTx{v}
			iNdEx = postIndex
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReapTxs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *RequestInsertTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestInsertTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestInsertTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RequestReapTxs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestReapTxs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestReapTxs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ResponseInsertTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseInsertTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseInsertTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ResponseReapTxs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseReapTxs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseReapTxs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
