...
func (m *ConsensusParams) GetAuthority() *AuthorityParams {
	if m != nil {
		return m.Authority
	}
	return nil
...
func (m *AuthorityParams) Reset()         { *m = AuthorityParams{} }
...
func (m *AuthorityParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AuthorityParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AuthorityParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AuthorityParams.Merge(m, src)
}
func (m *AuthorityParams) XXX_Size() int {
	return m.Size()
}
func (m *AuthorityParams) XXX_DiscardUnknown() {
	xxx_messageInfo_AuthorityParams.DiscardUnknown(m)
}

var xxx_messageInfo_AuthorityParams proto.InternalMessageInfo

func (m *AuthorityParams) GetAuthority() string {
	if m != nil {
		return m.Authority
	}
	return ""
...
var fileDescriptor_e12598271a686f57 = []byte{
	...
	,
}
...
func (this *AuthorityParams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AuthorityParams)
	if !ok {
		that2, ok := that.(AuthorityParams)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *AuthorityParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AuthorityParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AuthorityParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AuthorityParams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AuthorityParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AuthorityParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AuthorityParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
